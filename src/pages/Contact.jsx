            ...
            <Col lg="5" md="5">
              <div className="contact__info">
                ...
                <p className="section__description mb-0">
                    ul. Myśliwska 5, 00-343 Warszawa
                </p>
                ...
                <div className=" d-flex align-items-center gap-2">
                  ...
                  <p className="section__description mb-0">bok@carently.com</p>
                </div>

                <h6 className="fw-bold mt-4">Obserwuj nas w mediach społecznościowych</h6>
